          ...
          <form className="reg-form" onSubmit={handleSave} noValidate>
            ...
            <div className="reg-uploads-row">
              ...
              <Field label="Upload Waiver / Consent Form" error={errors.waiver}>
                ...
                <a
                  className="reg-template-link"
                  href="/templates/parental-consent-form.docx"
                  download="Parental Consent Form - Santa Rita College of Pampanga.docx"
                >
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z"/></svg>
